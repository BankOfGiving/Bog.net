    ...
    (function(q) {
        ...
        (function(q) { "function" === typeof require && "object" === typeof exports && "object" === typeof module ? q(module.exports || exports) : "function" === typeof define && define.amd ? define(["exports"], q) : q(w.ko = {}); })(function(C) {
            ...
            a.Ea = function() {
                ...
                return {
                    Ab: function(b, c, d) { c.isTemplateRewritten(b, d) || c.rewriteTemplate(b, function(b) { return a.Ea.Lb(b, c); }, d); },
                    Lb: function(a, g) { return a.replace(c, function(a, c, d, f, l) { return b(l, c, d, g); }).replace(d, function(a, c) { return b(c, "\x3c!-- ko --\x3e", "#comment", g); }); },
                    qb: function(b, c) {
